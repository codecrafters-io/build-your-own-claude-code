...
This is a starting point for Julia solutions to the
...
The entry point for your `claude-code` implementation is in `app/main.jl`. Study
...
1. Ensure you have `julia (1.11)` installed locally.

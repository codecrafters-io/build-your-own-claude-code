...
This is a starting point for R solutions to the
...
The entry point for your `claude-code` implementation is in `app/main.R`. Study
...
1. Ensure you have `Rscript` installed locally.
